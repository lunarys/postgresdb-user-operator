...
KIND_CLUSTER ?= postgresdb-user-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name postgresdb-user-operator-builder
	$(CONTAINER_TOOL) buildx use postgresdb-user-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm postgresdb-user-operator-builder
	rm Dockerfile.cross
